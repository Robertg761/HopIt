...
Options:
  ...
  --advanced           setup: also prompt for agent state, codebase, env, and login-service options
  ...
  --projects-source <dir> setup: scan this folder for existing projects and offer them in the same approval
