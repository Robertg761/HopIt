...
- Add root-level codebase discovery and attach/hydrate state. D1 account-visible discovery, dashboard metadata-only attach, and hydration/readiness state are in place; automatic first-run setup and richer attach/hydrate onboarding remain.
