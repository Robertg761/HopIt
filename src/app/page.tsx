...
import { type AgentCommand, useAgentStatus } from '@/hooks/use-agent-status'
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="command-deck-canvas min-h-screen">
        <TopDock status={status} loading={agentStatus.loading} />

        <main className="mx-auto flex w-full max-w-[1680px] flex-col gap-5 px-3 py-4 sm:px-4 lg:px-6 lg:py-6">
          ...
          <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(360px,0.48fr)]">
          ...
          <section id="work-items" className="scroll-mt-24">
            <ModuleFrame
          ...
          <section id="activity" className="scroll-mt-24">
            <ModuleFrame
              ...
              title="Sync history, review signals, and agent activity"
              icon={Activity}
          ...
          {moduleAnchors.map((item) => {
            ...
            return (
              <a
                ...
                className="inline-flex h-8 shrink-0 items-center gap-1.5 rounded-md border border-transparent px-2.5 text-xs font-medium text-muted-foreground transition hover:border-border hover:bg-card hover:text-foreground"
              >
